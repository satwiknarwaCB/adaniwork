...
const SOLAR_SECTIONS = [
  ...
  { value: 'Khavda Solar', label: 'A. Khavda Solar' },
  { value: 'Rajasthan Solar', label: 'B. Rajasthan Solar' },
  { value: 'Rajasthan Solar Additional 500MW', label: 'C. Rajasthan Additional' },
];
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">AGEL FY 2025-26 Solar Commissioning Status</p>
            </div>
          </div>
